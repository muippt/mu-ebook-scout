...
- 📚 **一搜到手**——搜「《高效能人士的七个习惯》」，社区书单的网盘直链连提取码一起排好序递到你面前
...
想找一本书，却不想在十个网站之间挨个打开、挨个搜？一次查询就把下表的书源并行问一遍，结果排好序递到你面前；个别源临时限流或失联会被跳过并如实上报，绝不拖垮整次搜索。先发一句「帮我找《高效能人士的七个习惯》」试试水。
...
习惯终端就敲一条命令，用 AI Agent 就让它替你搜，搭了 MCP 客户端就当工具调用——同一个引擎，换着姿势用。安装后对 Agent 说一句「帮我找一本《高效能人士的七个习惯》的电子书」就能上手。
...
```
帮我找一本《高效能人士的七个习惯》的电子书，最好有 EPUB 格式。
```
